...
export const Route = createFileRoute("/forgetnews")({
  head: () => ({
    meta: [
  ...
  component: ForgetnewsRedirect,
});

function ForgetnewsRedirect() {
  useEffect(() => {
    window.location.replace(
      `/forgetnews/index.html${window.location.search}${window.location.hash}`,
    );
  }, []);
